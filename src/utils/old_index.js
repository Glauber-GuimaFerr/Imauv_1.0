...
//Ponto//
        ...
        var currentIcon = new LeafIcon({iconUrl: '/img/menu/current-position-icon.png'}),
        grayIcon = new LeafIcon({iconUrl: '/img/menu/marker-gray-icon.png'}),
        blueIcon = new LeafIcon({iconUrl: '/img/menu/marker-blue-icon.png'}),
        greenIcon = new LeafIcon({iconUrl: '/img/menu/marker-green-icon.png'}),
        yellowIcon = new LeafIcon({iconUrl: '/img/menu/marker-yellow-icon.png'}),
        redIcon = new LeafIcon({iconUrl: '/img/menu/marker-red-icon.png'});
...
//Barra de pesquisa//
        ...
        var marker = L.marker(latlng,{icon: grayIcon}).addTo(map);
...
//Botão de marcar ponto e adição de área//
        ...
        imgPlus.src = '/img/menu/plus-icon.png';
...
//Botão de retornar para posição atual//
        ...
        imgSchg.src = '/img/menu/location-searching-icon.png';
...
//Botão de editar processos//
        ...
        imgEdit.src = '/img/menu/edit-icon.png';
...
//Botão de visualizar processos do usuário//
        ...
        imgPr.src = '/img/menu/list-icon.png';
...
//Botão de abrir a página de usuário//
        ...
        imgUser.src = '/img/menu/user-icon.png';
...
//Botão de histórico//
        ...
        imgHist.src = '/img/menu/history-icon.png';
